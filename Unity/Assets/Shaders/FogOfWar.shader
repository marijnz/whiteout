...
////// Lighting:
////// Emissive:
                float2 node_1054 = i.uv0;
                float4 node_768 = tex2D(_FogTexture,TRANSFORM_TEX(node_1054.rg, _FogTexture));
                float3 emissive = node_768.rgb;
                float3 finalColor = emissive;
                float node_1010 = (1.0 - tex2D(_HitpointMap,TRANSFORM_TEX(node_1054.rg, _HitpointMap)).g);
/// Final Color:
