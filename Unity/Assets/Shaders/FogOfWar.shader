...
////// Emissive:
                ...
                float4 node_768 = tex2D(_FogTexture,TRANSFORM_TEX(node_1098.rg, _FogTexture));
                float3 emissive = node_768.rgb;
                float3 finalColor = emissive;
                float node_1010 = (1.0 - tex2D(_HitpointMap,TRANSFORM_TEX(node_1098.rg, _HitpointMap)).g);
/// Final Color:
