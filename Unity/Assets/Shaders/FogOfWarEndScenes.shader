...
Shader "Shader Forge/FogOfWarEndScenes" {
    Properties {
        ...
        _AlphaOveride ("AlphaOveride", Float ) = 0
...
////// Emissive:
                ...
                float2 node_1486 = i.uv0;
/// Final Color:
                return fixed4(finalColor,(_AlphaOveride+(1.0 - tex2D(_HitpointMap,TRANSFORM_TEX(node_1486.rg, _HitpointMap)).g)));
            }
            ENDCG
        }
    }
